...
var upgrades = [
	...
	{"name": "Club","friendly":false, "category": "weapon", "type": "damage","scale": "hp","weight": 20, "cost": 2, "icon":           "res://Assets/atlas/leaf.tres","index": 0, "amount": 10, "speed": 4, "level": 1},
	{"name": "Staff","friendly":false,    "category": "weapon", "type": "damage","scale": "hp","weight": 20, "cost": 2, "icon":           "res://Assets/atlas/leaf.tres","index": 1,   "amount": 8,  "speed": 6, "level": 1},
