...
static var upgrades = [
	...
	{"name": "Club","friendly":true, "category": "weapon", "type": "DMG","weight": 200000, "cost": 2, "icon":           "res://Assets/atlas/icon.tres","index": 12, "amount": 10, "speed": 4, "level": 0},
	{"name": "Staff","friendly":false,    "category": "weapon", "type": "DMG","weight": 200000, "cost": 2, "icon":           "res://Assets/atlas/icon.tres","index": 14,   "amount": 8,  "speed": 6, "level": 0},
